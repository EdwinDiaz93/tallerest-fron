                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex justify-left gap-4">
                                            <button onClick={() => showData(row)} x-data="{ tooltip: 'Edite' }" >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-blue-500 font-bold">
                                            ...
                                            <button onClick={() => editData(row)} x-data="{ tooltip: 'Edite' }" >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-orange-500 font-bold">
