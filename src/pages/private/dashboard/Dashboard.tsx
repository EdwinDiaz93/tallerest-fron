...
const Dashboard = ({ options }: Props) => {
  ...
  const inactive = `text-gray-600 group`;
            ...
            <li>
              {
                options.map((option: any) => (
                  <Link to={option.path} aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl" key={option.id}>
                    ...
                    <span className="-mr-1 font-medium">{option.name}</span>
                  </Link>
                ))
              }
            </li>
